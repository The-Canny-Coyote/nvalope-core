...
- The bar is **one horizontal row** of section tabs. If many additional features are enabled, the row **scrolls sideways** (`overflow-x: auto`, touch-friendly panning) instead of wrapping to a second row.
